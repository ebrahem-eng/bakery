...
<div class="mb-8 glass-panel p-4 rounded-2xl border border-slate-200 dark:border-white/5">
    <form action="{{ route('admin.accounts.index') }}" method="GET" class="flex flex-col md:flex-row items-end gap-4">
        ...
        <div class="flex gap-2 w-full md:w-auto">
            ...
            @if($period === 'custom' || request()->has('date_from'))
                <a href="{{ route('admin.accounts.index') }}" class="flex-1 md:flex-none px-6 py-2.5 bg-slate-100 dark:bg-white/5 hover:bg-slate-200 dark:hover:bg-white/10 text-slate-600 dark:text-slate-400 font-bold text-xs uppercase tracking-wider rounded-xl transition-all text-center">
                    {{ __('Reset') }}
                </a>
            @endif
        </div>
