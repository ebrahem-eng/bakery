...
<div class="flex gap-1 mb-6 p-1 glass-panel rounded-2xl border border-slate-200 dark:border-white/5 w-fit">
    ...
    <a href="{{ route('admin.settings.translations.index') }}"
        class="px-5 py-2.5 rounded-xl text-sm font-bold transition-all flex items-center gap-2 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-white/5">
