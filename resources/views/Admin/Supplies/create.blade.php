            ...
            <div class="glass-panel p-6 rounded-2xl border border-white/10 relative overflow-hidden transition-all hover:border-white/20">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 items-start">
                    ...
                    <div class="lg:col-span-4 flex flex-col justify-between h-full">
                        ...
                        <div class="mt-2">
                            <label class="block text-[10px] text-emerald-400 mb-1 text-right">{{ __('Amount Paid From Register') }}</label>
                            <input type="number" step="0.01" x-bind:name="`supplies[${index}][paid_amount]`" x-model="item.paid_amount" class="glass-input w-full px-3 py-2 rounded-lg text-sm text-right font-bold text-emerald-300">
                        </div>
                    </div>
                </div>
            </div>
