...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="glass-panel p-6 rounded-2xl relative overflow-hidden group border-sky-500/20">
        <div class="absolute top-0 right-0 p-3 opacity-10 group-hover:scale-110 transition-transform text-sky-500">
    ...
    <div class="glass-panel p-6 rounded-2xl relative overflow-hidden group border-amber-500/20">
        <div class="absolute top-0 right-0 p-3 opacity-10 group-hover:scale-110 transition-transform text-amber-500">
    ...
    <div class="glass-panel p-6 rounded-2xl relative overflow-hidden group border-[#0ea5e9]/30 bg-gradient-to-br from-[#0ea5e9]/5 to-transparent">
        <div class="absolute top-0 right-0 p-3 opacity-20 group-hover:scale-110 transition-transform text-[#0ea5e9]">
