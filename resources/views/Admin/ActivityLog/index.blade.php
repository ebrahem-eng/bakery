...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
        ...
        <form action="{{ route('admin.activity-log.clear') }}" method="POST" data-confirm data-confirm-title="{{ __('Clear All Logs') }}" data-confirm-message="{{ __('Are you sure? This will permanently delete ALL activity log entries.') }}">
            @csrf @method('DELETE')
