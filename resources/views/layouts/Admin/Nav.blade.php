            ...
            <header class="glass-navbar border-b border-slate-200 dark:border-white/5 z-10 w-full transition-colors duration-500">
                <div class="flex items-center justify-between px-6 py-4">
                    <!-- Hamburger Toggle -->
                    <button @click="sidebarOpen = true" class="text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white lg:hidden p-2 hover:bg-slate-100 dark:hover:bg-white/5 rounded-lg transition-colors">
