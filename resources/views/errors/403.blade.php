...
<body class="antialiased font-sans text-slate-900 dark:text-slate-300">
    ...
    <div class="fixed inset-0 z-[-2] bg-slate-50 dark:bg-[#0f1115]">
        <div class="hidden dark:block absolute top-[-15%] left-[-10%] w-[60%] h-[60%] rounded-full bg-red-500/10 blur-[140px] pointer-events-none"></div>
    ...
    <div class="min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-8">
        <div class="error-card bg-white/80 dark:bg-white/[0.04] border border-slate-200 dark:border-white/[0.06] rounded-3xl shadow-2xl dark:shadow-red-900/10 max-w-lg w-full p-6 sm:p-12 text-center transition-all duration-300">
            ...
            <!-- Error Code -->
            <h1 class="error-code text-6xl sm:text-7xl md:text-8xl font-extrabold mb-2 tracking-tight">403</h1>
